  ...
  <section className="mb-12">
    ...
    <div className="grid grid-cols-4 gap-6">
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-4">
            <ColorBox className="bg-secondary text-on-secondary">
              Secondary
            </ColorBox>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center gap-4">
            <ColorBox className="bg-surface-variant text-on-surface-variant">
              Variant
            </ColorBox>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-4">
            <ColorBox className="border-4 border-outline bg-surface text-on-surface">
              Outline
            </ColorBox>
            <code className="text-sm">border-outline</code>
          </div>
          <div className="flex items-center gap-4">
            <ColorBox className="border-4 border-outline-variant bg-surface text-on-surface">
              Variant
            </ColorBox>
...
const SemanticSection = () => (
  <section className="mb-12">
    ...
    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3">
      <div className="flex items-center gap-4">
        <ColorBox className="bg-background text-foreground">
          Background
        </ColorBox>
