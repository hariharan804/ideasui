      ...
      <table className="w-full border-collapse border border-gray-300">
        ...
        <tbody>
          <tr>
            ...
            <td className="border border-gray-300 px-4 py-2 font-mono text-sm">'default' | 'destructive' | 'outline' | 'secondary' | 'ghost' | 'link'</td>
            <td className="border border-gray-300 px-4 py-2 font-mono text-sm">'default'</td>
            <td className="border border-gray-300 px-4 py-2">The visual style variant of the button</td>
          </tr>
          <tr className="bg-gray-50">
            <td className="border border-gray-300 px-4 py-2 font-mono text-sm">size</td>
            <td className="border border-gray-300 px-4 py-2 font-mono text-sm">'default' | 'sm' | 'lg' | 'icon'</td>
            <td className="border border-gray-300 px-4 py-2 font-mono text-sm">'default'</td>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              ...
              <span className="bg-blue-100 text-blue-800 px-2 py-1 rounded text-sm">Component</span>
            </div>
            <div className="flex items-center space-x-4">
              <a href="/library" className="text-blue-600 hover:text-blue-800">← Back to Library</a>
            </div>
          </div>
        </div>
      </div>
              ...
              <div className="space-y-8">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mb-4">
                    The Button component uses Tailwind CSS classes. You can customize the appearance by overriding these classes.
                  </p>
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <p className="font-mono text-sm">Base classes: inline-flex items-center justify-center rounded-md text-sm font-medium</p>
                  </div>
                </div>
              </div>
            )}
