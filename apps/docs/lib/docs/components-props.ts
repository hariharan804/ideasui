  ...
  radio: [
    {
      ...
      props: [
        ...
        },
        {
          ...
          defaultValue: "'md'",
          deprecated: false,
          description: 'Size scale of the radio.',
        },
        {
          name: 'radius',
          type: 'RadioRadius',
          ...
          defaultValue: "'full'",
          deprecated: false,
          description: 'Border radius corner shape of the radio indicator.',
        },
        {
          name: 'isSelected',
          type: 'boolean',
          ...
          defaultValue: null,
          deprecated: false,
          description: 'Controlled selected state when used standalone.',
        },
        {
          name: 'defaultSelected',
          type: 'boolean',
          ...
          defaultValue: 'false',
          deprecated: false,
          description: 'Uncontrolled default selected state when used standalone.',
        },
        {
          name: 'isToggleable',
          type: 'boolean',
          ...
          deprecated: false,
          description:
            'Whether pressing an already selected radio unchecks it. Defaults to true for standalone Radio, and inherits from RadioGroup if in a group.',
        },
        {
          name: 'isDisabled',
          type: 'boolean',
          ...
          defaultValue: 'false',
          deprecated: false,
          description: 'Marks the radio as disabled.',
        },
        {
          name: 'isReadOnly',
          type: 'boolean',
          ...
          defaultValue: 'false',
          deprecated: false,
          description: 'Marks the radio as read-only.',
        },
        {
          name: 'isRequired',
          type: 'boolean',
        ...
        },
        {
          ...
          defaultValue: null,
          deprecated: false,
          description: 'Value of the radio option when used inside a RadioGroup.',
        },
        {
          name: 'onChange',
          type: '(isSelected: boolean) => void',
          ...
          defaultValue: null,
          deprecated: false,
          description: 'Change handler — receives boolean selected state or value.',
        },
        {
          name: 'className',
          type: 'string',
        ...
        },
        {
          ...
          deprecated: false,
          description:
            'Custom icon/element rendered inside indicator when selected. Can be a ReactNode or a render function receiving `{ className: string }`.',
        },
      ],
    },
    {
      ...
      props: [
        {
          ...
          defaultValue: null,
          deprecated: false,
          description: 'Form control name propagated to all nested radio inputs.',
        },
        {
          name: 'value',
          type: 'string',
          ...
          defaultValue: null,
          deprecated: false,
          description: 'Controlled value of the selected radio option.',
        },
        {
          name: 'defaultValue',
          type: 'string',
          ...
          defaultValue: null,
          deprecated: false,
          description: 'Uncontrolled default value of the selected radio option.',
        },
        {
          name: 'onChange',
          type: '(value: string) => void',
          ...
          defaultValue: null,
          deprecated: false,
          description: 'Change handler — receives the newly selected option value string.',
        },
        {
          name: 'variant',
          type: 'RadioVariant',
          ...
          defaultValue: "'outline'",
          deprecated: false,
          description: 'Visual style variant propagated to all child Radios.',
        },
        {
          name: 'color',
          type: 'RadioColor',
          ...
          defaultValue: "'primary'",
          deprecated: false,
          description: 'Color propagated to all child Radios.',
        },
        {
          name: 'size',
          type: 'RadioSize',
          ...
          defaultValue: "'md'",
          deprecated: false,
          description: 'Size scale propagated to all child Radios.',
        },
        {
          name: 'radius',
          type: 'RadioRadius',
          ...
          defaultValue: "'full'",
          deprecated: false,
          description: 'Border radius corner shape propagated to all child Radios.',
        },
        {
          name: 'orientation',
          type: '"vertical" | "horizontal"',
        ...
        },
        {
          ...
          defaultValue: 'false',
          deprecated: false,
          description: 'Marks all radios in the group as disabled.',
        },
        {
          name: 'isReadOnly',
          type: 'boolean',
          ...
          defaultValue: 'false',
          deprecated: false,
          description: 'Marks all radios in the group as read-only.',
        },
        {
          name: 'isRequired',
          type: 'boolean',
        ...
        },
        {
          ...
          defaultValue: null,
          deprecated: false,
          description: 'Inline styles applied to the root fieldset element.',
        },
        {
          name: 'children',
          type: 'ReactNode',
    ...
    },
    {
      ...
      props: [
        ...
        },
        {
          ...
          defaultValue: null,
          deprecated: false,
          description: 'Label content rendered above the group of radios.',
        },
      ],
    },
    {
      ...
      props: [
        ...
        },
        {
          ...
          defaultValue: null,
          deprecated: false,
          description: 'Accessible description text rendered below the radio group when valid.',
        },
      ],
    },
    {
      ...
      props: [
        ...
        },
        {
          ...
          defaultValue: null,
          deprecated: false,
          description: 'Error text rendered below the radio group when isInvalid is true.',
        },
      ],
    },
  ],
