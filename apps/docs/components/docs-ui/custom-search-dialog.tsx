...
export function CustomSearchDialog({
  ...
  return (
    <SearchDialog isLoading={query.isLoading} search={search} onSearchChange={setSearch} {...props}>
      {/* Overlay */}
      <SearchDialogOverlay className="data-[state=open]:animate-fd-fade-in data-[state=closed]:animate-fd-fade-out bg-background/60 fixed inset-0 z-[99999] backdrop-blur-2xl transition-opacity" />
