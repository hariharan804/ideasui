// @ts-nocheck
import { default as __fd_glob_18 } from "../content/react/start/meta.json?collection=meta"
import { default as __fd_glob_17 } from "../content/react/components/meta.json?collection=meta"
import { default as __fd_glob_16 } from "../content/react/meta.json?collection=meta"
import * as __fd_glob_15 from "../content/react/components/(typography)/text.mdx?collection=docs"
...
export const docs = await create.doc("docs", "content/react", {"changelog.mdx": __fd_glob_0, "components/index.mdx": __fd_glob_1, "start/dark-mode.mdx": __fd_glob_2, "start/design-principles.mdx": __fd_glob_3, "start/frameworks.mdx": __fd_glob_4, "start/index.mdx": __fd_glob_5, "start/quick-start.mdx": __fd_glob_6, "start/standalone-css.mdx": __fd_glob_7, "start/styling.mdx": __fd_glob_8, "start/theming.mdx": __fd_glob_9, "start/tokens.mdx": __fd_glob_10, "components/(buttons)/button-group.mdx": __fd_glob_11, "components/(buttons)/button.mdx": __fd_glob_12, "components/(inputs)/checkbox.mdx": __fd_glob_13, "components/(inputs)/input-field.mdx": __fd_glob_14, "components/(typography)/text.mdx": __fd_glob_15, });

export const meta = await create.meta("meta", "content/react", {"meta.json": __fd_glob_16, "components/meta.json": __fd_glob_17, "start/meta.json": __fd_glob_18, });