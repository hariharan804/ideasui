...
import { default as __fd_glob_6 } from "../content/react/getting-started/meta.json?collection=meta"
...
export const meta = await create.meta("meta", "content/react", {"meta.json": __fd_glob_5, "getting-started/meta.json": __fd_glob_6, "components/meta.json": __fd_glob_7, });