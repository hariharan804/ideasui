export const THEME_ADDON_ID = 'ideasui-theme-addon';
export const THEME_GLOBAL_TYPE_ID = 'ideasui-theme';
export const THEME_PARAM_KEY = 'ideasui-theme';
export const THEME_EVENT_NAME = 'ideasui-theme-changed';
