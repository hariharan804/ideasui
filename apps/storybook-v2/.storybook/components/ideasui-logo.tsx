...
export function IdeasUILogo({ className, height, size = 26, width }: IdeasUILogoProps) {
  // Calculate dimensions based on original aspect ratio (5:1)
  const aspectRatio = 5;
  ...
  return (
    ...
    >
      <path d="M12 2.5L20.6603 7.5V17.5L12 22.5L3.33975 17.5V7.5L12 2.5Z" fill="#6366F1" />
      <path
      ...
      <g transform="translate(40, 28)">
        <rect x="0" y="-18" width="5.5" height="18" rx="1" fill="currentColor" />
        <path
