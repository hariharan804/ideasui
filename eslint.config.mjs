  ...
  // Main configuration
  {
    ...
    rules: {
      ...
      '@typescript-eslint/naming-convention': [
        ...
        { selector: 'variable', modifiers: ['const'], filter: { regex: '^[A-Z][A-Z0-9_]*$', match: true }, format: ['UPPER_CASE'] }
      ],
      ...
      'react-hooks/exhaustive-deps': ['warn', { additionalHooks: '(useMyCustomHook|useAnotherHook)' }],
